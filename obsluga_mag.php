...
//    }
    ...
    <h2 align="center">Wyszukiwanie eksponatów</h2><br>
    <form action="wyniki_pracownik.php" method="post">
        <center>
            ...
            <input type="hidden" name="opcja_wyszukaj" value="1" checked>
    ...
    <form action="wyniki_pracownik.php" method="post">
        ...
        <input type="hidden" name="opcja_wyszukaj" value="1" checked>
        <input type="submit" value="Wyświetl wszystkie dzieła na wystawach">
    </form>
    ...
    <br>
    <form action="new_event.php" method="post"><br>
        ID: <input type="text" name="id" value="0"><br><br>
        Tytuł: <input type="text" name="tytul"><br><br>
        <input type="hidden" name="lokalizacja" value="Wystawa">
