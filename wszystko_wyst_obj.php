...
<div class="col-sm-11 text-left">
    ...
    $wynik = pg_exec($link, "SELECT Eksponaty.id_eksponatu, Eksponaty.tytul, Eksponaty.typ, Wystawy_objazdowe.id_wystawy, Miasta.nazwa, historia_ekspozycji.poczatek, Wystawy_objazdowe.data_zakonczenia
			      ...
			      WHERE historia_ekspozycji.koniec IS NULL AND Eksponaty.obecna_lokalizacja='O'");
    ...
    if ($ile==0) {
        ...
        ?>
        <h2 align=center>Eksponaty na wystawach objazdowych</h2>
        ...
        <tr>
            ...
            <th>Nazwa wystawy</th>
            <th>Nazwa miasta</th>
            <th>Początek wystawy objazdowej</th>
	    ...
	    <td>" . $wiersz["tytul"] . "</td>
	    <td>" . $wiersz["typ"] . "</td>";
            echo "<td>" . $wiersz["nazwa_wystawy_objazdowej"] . "</td>
